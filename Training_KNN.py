...
model = KNeighborsRegressor(n_neighbors=5)  # You can adjust the number of neighbors (n_neighbors) based on your needs
...
with open(output_file, 'a', newline='') as csvfile:
    ...
    data_row = [StartTime.strftime("%Y-%m-%d_%H:%M:%S"),EndTime.strftime("%Y-%m-%d_%H:%M:%S"),"KNN",mse]
