...
lasso_model = Lasso(alpha=1.0)  # You can adjust the regularization strength (alpha) based on your needs

# Train the Lasso model on the scaled training set
...
with open(output_file, 'a', newline='') as csvfile:
    ...
    data_row = [StartTime.strftime("%Y-%m-%d_%H:%M:%S"),EndTime.strftime("%Y-%m-%d_%H:%M:%S"),"Lasso",mse]
